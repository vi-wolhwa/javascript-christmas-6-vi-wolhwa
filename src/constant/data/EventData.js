...
const EVENT_DATA = deepFreeze([
  {
    ...
    benefits: (orderForm) => 1000 + (100 * (orderForm.day - 1)),
  ...
  },
  {
    ...
    benefits: (orderForm) => 2023 * orderForm.count[category.dessert],
  ...
  },
  {
    ...
    benefits: (orderForm) => 2023 * orderForm.count[category.main],
